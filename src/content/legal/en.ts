  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "We plan to display advertising through third-party ad networks, including Google AdSense and Monetag. Once enabled, these networks may use cookies, device identifiers, or similar technologies to serve ads and measure their performance, which can include personalized advertising based on your browsing activity across sites.",
  ...
  terms: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "The App may display advertisements served by third-party networks (such as Google AdSense and Monetag) once enabled. We do not control the content of third-party ads and are not responsible for the products, services, or content they promote. Interacting with any ad is at your own discretion and risk.",
        ],
      },
      {
  ...
  cookies: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Once we enable advertising through third-party networks such as Google AdSense and Monetag, those networks may set their own cookies or use device identifiers to serve and measure ads, including personalized ads based on browsing activity. We will ask for your consent to these non-essential cookies through the banner shown in the App, in line with applicable law, and you'll be able to choose \"Necessary only\" to opt out of them.",
        ],
      },
      {
